...
<div className="main">
        <div className="row row-2">
                <div className="text-panel text-panel-alpenrose" id="alpenrose">
                        <h1 className="section-title-alpenrose">Hey Alpen - Hey What?!? </h1>
        ...
        <div className="row row-4">
                ...
                <div className="text-panel text-panel-retreat-2026" id="retreat-2026">
        ...
        <div className="row row-6">
                ...
                <div className="image-panel panel-36"><p>36</p></div>
        </div>
        ...
        <div className="row row-13">
                ...
                <div className="image-panel panel-37"><p>37</p></div>
